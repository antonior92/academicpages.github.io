...
On the industry side I've worked as hardware developer intern at [Invent Vision](http://www.ivision.ind.br), a startup that produces industrial cameras. There I developed the prototype of a FPGA-based stereo camera. 
...
During the last few months I have worked on my [Google Summer of Code](https://summerofcode.withgoogle.com) project: a large-scale optimization algorithm to be integrated to Scipy. The implementation is available in [this](https://github.com/antonior92/ip-nonlinear-solver) github repository and is being integrated to SciPy through the pull request [\#7729](https://github.com/scipy/scipy/pull/7729).
