...
I've some contributions to large open-source projects such as [Scipy](https://www.scipy.org/scipylib/index.html) library, with contributions such as IIR filters implementations to the signal processing package (function [``iirnotch``](http://scipy.github.io/devdocs/generated/scipy.signal.iirnotch.html#scipy.signal.iirnotch) and [``irrpeak``](http://scipy.github.io/devdocs/generated/scipy.signal.iirpeak.html#scipy.signal.iirpeak)) and trust-region methods to the optimization package (method [``trust-exact``](http://scipy.github.io/devdocs/optimize.minimize-trustexact.html)). I've also made improvements on some already implemented methods (such as the [``BFGS``](http://scipy.github.io/devdocs/optimize.minimize-bfgs.html) implementation). 
